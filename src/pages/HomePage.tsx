...
const quickActions = [
  { title: "Upload Dataset", desc: "Carga un archivo CSV para comenzar", icon: Upload, href: "/upload", color: "bg-primary/10 text-primary" },
  { title: "SQL Lab", desc: "Ejecuta consultas SQL sobre tus datos", icon: Database, href: "/sql-lab", color: "bg-chart-2/10 text-chart-2" },
  { title: "Data Viz", desc: "Crea visualizaciones interactivas", icon: BarChart3, href: "/data-viz", color: "bg-chart-3/10 text-chart-3" },
  { title: "Model Lab", desc: "Entrena modelos de ML", icon: Brain, href: "/model-lab", color: "bg-chart-4/10 text-chart-4" },
];
...
const modelDocs = [
  {
    ...
    simple:
      "Traza una línea para predecir un número.",
  },
  {
    name: "Ridge",
    ...
    simple:
      "Es como Linear Regression, pero más estable.",
  },
  {
    name: "Lasso",
    ...
    simple:
      "Puede apagar variables que no aportan.",
  },
  {
    name: "SVR",
    ...
    simple:
      "Intenta predecir números sin reaccionar de más a ruido.",
  },
  {
    name: "Decision Tree",
    ...
    simple:
      "Hace preguntas una por una hasta llegar a una decisión.",
  },
  {
    ...
    simple:
      "Predice si algo pertenece o no a una clase.",
  },
  {
    name: "KNN",
    ...
    simple:
      "Mira a los más parecidos y vota.",
  },
  {
    name: "SVM",
    ...
    simple:
      "Traza una frontera que deje a los grupos mejor separados.",
  },
  {
    name: "Naive Bayes",
  ...
  },
  {
    ...
    simple:
      "Va mejorando paso a paso con árboles.",
  },
  {
    name: "AdaBoost",
    ...
    simple:
      "Se enfoca más en los casos difíciles.",
  },
];
...
export default function HomePage() {
  return (
    <div className="space-y-8 max-w-7xl">
      <div>
        <h1 className="section-title gradient-text text-3xl">Bienvenido a ML Playground</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard title="Datasets" value={3} subtitle="Cargados" icon={<Database className="h-5 w-5" />} />
        <MetricCard title="Experimentos" value={12} subtitle="Ejecutados" icon={<Beaker className="h-5 w-5" />} />
        <MetricCard
        ...
        />
        <MetricCard title="Modelos" value={12} subtitle="Disponibles" icon={<Brain className="h-5 w-5" />} />
      </div>

      <div>
        <h2 className="font-heading font-semibold text-lg mb-4">Datasets demo</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {featuredDatasets.map((dataset) => (
            ...
            >
              <div className={`h-10 w-10 rounded-lg ${dataset.color} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform`}>
                <dataset.icon className="h-5 w-5" />
              </div>
              <h3 className="font-heading font-semibold text-sm">{dataset.title}</h3>
      ...
      <div>
        <h2 className="font-heading font-semibold text-lg mb-4">Acciones rápidas</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="glass-card p-6">
        <h2 className="font-heading font-semibold text-lg mb-3">Modelos disponibles</h2>
          ...
          {modelDocs.map((m) => (
            ...
            >
              <div className="flex items-center justify-between gap-3 mb-2">
                ...
                <span className="text-[11px] rounded-full bg-muted/50 px-2 py-1">ver en Model Lab</span>
              </div>
              <div className="text-xs text-muted-foreground">
                <div className="mb-2"><span className="font-medium text-foreground">Técnico:</span> {m.technical}</div>
                <div><span className="font-medium text-foreground">Sencillo:</span> {m.simple}</div>
              </div>
            </Link>
          ))}
        </div>
